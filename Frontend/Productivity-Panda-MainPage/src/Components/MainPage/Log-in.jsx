    ...
    <div className='log-in-page white-background'>
      <div className="log-in-container">
        ...
        <form className="log-in-form">
          ...
          <input className="log-in-input" type="email" id="email" placeholder='Enter your email'/>

          <label className="log-in-label" htmlFor="password">Password</label>
          <input className="log-in-input" type="password" id="password" placeholder='Enter your password' />
